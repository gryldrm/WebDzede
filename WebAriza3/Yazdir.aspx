        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="id" CellPadding="4"  >
            ...
            <ItemTemplate>
               <table border="1" style="border-style: solid; border-color: #000000; border-collapse: collapse; " >
                    <tr>
                        <td  colspan="3" style="text-align: center; " class="auto-style2"><strong style="border-color: #000000; border-collapse: collapse">ARİZA / TALEP BİLDİRİM FORMU<br />
                            <br />
                            </strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3" style="border-color: #000000; border-collapse: collapse" class="auto-style3"><strong>Bilgi Teknolojileri ve Haberleşme Şube Müdürlüğünce Yapılan İşlem</strong></td>
                    </tr>
                    <tr>
